    ...
    return (
        <Card className="mt-5">
            <CardHeader>
                ...
                <CardDescription>
                    When this product is Featured, it will appear in featured section on the live products list.
                </CardDescription>
            </CardHeader>
            <CardContent>
                {!isEditing && (
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                        ...
                                        <div className="space-y-1 leading-none">
                                            ...
                                            <FormDescription>
                                                This product will appear in the featured section of your store.
                                            </FormDescription>
                                        </div>
                                    </FormItem>
                                )}
